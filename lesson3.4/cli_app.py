...
# cd lesson3.4
# python cli_app.py add --name "Messi" --age 37 --email lionelpepsi@gmail.com
# python cli_app.py add --name "Neymar" --age 33
# python cli_app.py add --name "Ronaldo" --age 40 --email ronaldocr7@gmail.com
